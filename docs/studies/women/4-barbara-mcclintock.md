...
```mermaid
gantt
    title Timeline of Barbara McClintock’s Life and Career
    dateFormat  YYYY
    axisFormat  %Y
    section Early Life & Education
    Born in Hartford               :a1, 1902, 0y
    Family moves to Brooklyn       :a2, 1908, 0y
    Erasmus Hall HS graduation     :a3, 1919, 0y
    BS in Botany, Cornell          :a4, 1923, 0y
    MS in Botany, Cornell          :a5, 1925, 0y
    PhD in Botany, Cornell         :a6, 1927, 0y

    section Academic Positions
    Instructor/Researcher, Cornell :b1, 1927, 4y
    Fellow, Guggenheim (Germany)   :b2, 1933, 1y
    Asst. Prof., Univ. of Missouri :b3, 1936, 4y
    Researcher, Cold Spring Harbor :b4, 1941, 26y

    section Honors & Later Work
    Nat’l Academy of Sciences      :c1, 1944, 0y
    President, Genetics Soc. of Am.:c2, 1945, 0y
    National Medal of Science      :c3, 1971, 0y
    MacArthur “Genius” Grant       :c4, 1981, 0y
    Nobel Prize, Medicine          :c5, 1983, 0y
    Died in Huntington             :c6, 1992, 0y
```
