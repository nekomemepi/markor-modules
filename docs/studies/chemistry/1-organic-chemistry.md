...
Organic chemistry is the branch of chemistry that focuses on the
structure, properties, composition, reactions, and synthesis of
carbon-containing compounds. These compounds typically contain
carbon-hydrogen (C–H) bonds, and may also include elements such as
...
Organic molecules are primarily composed of carbon atoms bonded to
hydrogen, oxygen, nitrogen, and other elements. Carbon can form four
covalent bonds, leading to a variety of structures:
...
Functional groups determine the chemical reactivity of organic
molecules. Common examples include:
...
```mermaid
graph TD
    A[Alkane] -->|Halogenation| B[Haloalkane]
    B -->|Hydrolysis| C[Alcohol]
    C -->|Oxidation| D[Aldehyde]
    D -->|Oxidation| E[Carboxylic Acid]
```
...
Organic synthesis involves constructing complex molecules from simpler
ones. It often requires:
...
Organic chemistry is foundational to biology, medicine, materials
science, and more. Mastery of its principles—structure, bonding,
reactivity, and synthesis—opens the door to understanding the
molecular world.
